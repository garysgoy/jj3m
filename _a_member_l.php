...
include ('_ggFunctions.php');
	...
	$rs = $db->query("select id, email, fullname, phone,referral,ref_name,manager,mgr_name,rank,username,date_add,last_ph,directs,status  from tblmember order by $sort $order limit $offset,$rows");
	$ctr = mysqli_fetch_array($db->query("select count(*) from tblmember"));
