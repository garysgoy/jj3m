...
?>
		...
		<div class="container content-body">
			<!--div id="welcome-bar"><i class="fa_icon fa fa-smile-o" style="padding-top: 12px;"></i> gary02，欢迎回来！</div-->
  <style>
.red {
  color: red;
}
...
<div class="container">
  <div class="col-md-6">
      ...
      <p>&nbsp;</p>
      <p>&nbsp;</p>
  		<p><span class="ph-title">我要帮助其他人</span></p>
  		<p>&nbsp;</p>
      <p>&nbsp;</p>
      <p><button type="button" class="btn btn-success shadow btn-lg" data-toggle="modal" data-target="#provideHelp<? echo (ggNextPH('timer')=='')?'':'1'; ?>">提供帮助</button></p>
        ...
        <div class="modal-dialog" style="width:300px">
            <div class="modal-content">
                <div class="modal-header btn-success">
                  ...
                  <h4 class="modal-title" id="myModalLabel">提供帮助</h4>
                </div>
...
<!--GG End -->
  <div class="col-md-6">
      ...
      <p>&nbsp;</p>
      <p>&nbsp;</p>
  		<p><span class="gh-title">我需要别人帮助</span></p>
  		<p>&nbsp;</p>
      <p>&nbsp;</p>
      <p><button type="button" class="btn btn-warning shadow btn-lg" data-toggle="modal" data-target="#requestHelpD">接受帮助</button></p>
  	</div>
  </div>
...
<div class="container" style="width: 60%;">
	<div class="col-md-2" style="font-size:16px; padding-top:5px;">参与者：</div>
	<div class="col-md-8">
...
<ul class="nav nav-tabs">
  <li role="presentation" class="active"><a href="#groupA" data-toggle="tab">提供帮助 (<? echo ggHelpCount('P'); ?>)</a></li>
    <li role="presentation"><a href="#groupC" data-toggle="tab">接受帮助 (<? echo ggHelpCount('G'); ?>)</a></li>
</ul>
      ...
      <div class="table-responsive">
        <?
          ...
          while ($row = mysqli_fetch_object($rs)) {
              ...
              echo "<tr><td>状态</td><td>配对编号</td><td>提供帮助</td><td></td><td>金额</td><td></td><td>接受帮助</td></tr>";
...
function openComplete() {
    $('#complete').window('open');  // open a window
    var frm = document.getElementById('uploadForm');
    //frm.innerHTML = '<form id="ff1" action="#" method="post" enctype="multipart/form-data">Attach image (scans, screen shots) confirming this transaction<br><br><input id="fileToUpload" type="file" name="fileToUpload"><br><br>Documents addition is desired, but not requirted.<br>Acceptable file formats are JPG, PNG, GIF (maximum 2MB)<br><br><a href="#" class="btn2 close" onclick="closeComplete()"><span class="btn btncancel">Close</span></a><a href="#" class="btn2 save" onclick="uploadFile()"><span class="btn btnsave2">Upload File</span></a><input type="Submit"></form>';
}
