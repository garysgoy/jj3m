...
class phptextClass
{
	...
	public function phpcaptcha($textColor,$backgroundColor,$imgWidth,$imgHeight,$noiceLines=0,$noiceDots=0,$noiceColor='#162453')
	{
		/* Settings */
		$text=$this->random();
		$font = './tools/phpcaptcha/font/monofont.ttf';/* font */
		$textColor=$this->hexToRGB($textColor);
	...
	/*for random string*/
	protected function random($characters=4,$letters = '23456789bcdfghjkmnpqrstvwxyz'){
//	protected function random($characters=6,$letters = '1234567890'){
		$str='';
