...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
	...
	<head>
		...
		<title> <?php echo $page_title != "" ? $page_title." - " : ""; ?>3M </title>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo ASSETS_URL; ?>/css/smartadmin-skins-3.css">
	  ...
	  <link rel="stylesheet" type="text/css" media="screen" href="<?php echo ASSETS_URL; ?>/js/plugin/jquery-easyui/themes/icon.css">
		...
		<!-- GG Not good for china
		<script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script> -->
		<script>
			if (!window.jQuery) {
				document.write('<script src="<?php echo ASSETS_URL; ?>/js/libs/jquery-2.1.1.min.js"><\/script>');
				// 3.2.1 rejected by bootstrap document.write('<script src="<?php echo ASSETS_URL; ?>/js/libs/jquery-3.2.1.min.js"><\/script>');
			}
		</script>
		...
		?>
				...
				<header id="header">
					<div id="logo-group">
						...
						<span id="logo"> <img src="<?php echo ASSETS_URL; ?>/img/logo-white.png" alt="SmartAdmin"> </span>
						<!-- END LOGO PLACEHOLDER -->

<?
// GG Added Project switch
						...
						<ul class="header-dropdown-list hidden-xs">
							<li>
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">
									<img src="<?php echo ASSETS_URL; ?>/img/blank.gif" class="flag flag-cn" alt="China"> <span> 中文 (中国) </span> <i class="fa fa-angle-down"></i> </a>
								<ul class="dropdown-menu pull-right">
									<li class="active">
