    <!-- 接受帮助 Modal -->
    <div class="modal fade" id="requestHelpM" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="width:300px">
            <div class="modal-content">
                <div class="modal-header btn-warning">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title" id="myModalLabel"><? echo $ls->titlegh[$lang]; ?> - Manager</h4>
                </div>
                <div class="modal-body">
                  <form action="" method="post" id="getHelpForm" name="get_help" class="bs-docs-example form-control" style="height: 480px;">
                    ...
                    <input type="hidden" name="mavro" id="mavro" value="manager">
				 </div>
                            <!--div class="input-group" style="padding-bottom:5px;">
