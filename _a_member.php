...
//$page_css[] = "";
$page_title = $mls->memberlist[$lang];
$page_nav["memberlist"]["active"] = true;
...
$ls->title = array("Member List","会员列表","會員列表");

?>
  <div id="p" class="easyui-panel" title="&nbsp;<i class='fa fa-home'></i>  <? echo $ls->title[$lang]; ?>" style="width:99%;padding:5px;">
