...
$ls->th = array('<th style="width:5%;">Ser</th><th style="width:19%;">Time</th><th style="width:16%;">Category</th><th style="width:22%;">Send By</th><th style="width:15%;">Subject</th><th style="width:11%;">Status</th><th style="width:10%;">Action</th>',
		'<th style="width:5%;">编号</th><th style="width:19%;">时间</th><th style="width:16%;">问题类别</th><th style="width:22%;">发件人</th><th style="width:15%;">标题</th><th style="width:11%;">状态</th><th style="width:10%;">操作</th>',
		'<th style="width:5%;">編號</th><th style="width:19%;">時間</th><th style="width:16%;">問題類別</th><th style="width:22%;">發件人</th><th style="width:15%;">標題</th><th style="width:11%;">狀態</th><th style="width:10%;">操作</th>');
$ls->successful = array("Message Sent","信息顺利提交","信息顺利提交");
