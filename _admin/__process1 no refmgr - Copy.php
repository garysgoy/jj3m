...
function ggProcess1($id) {
	...
	while ($row = mysqli_fetch_object($db->query("select * from tblhelp where g_type='$second' and status = 'P' and note<>'referral' and note<>'manager' and mem_id <> $mem_id order by id limit 1")) and $bal > 0) {
