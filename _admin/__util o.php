...
//		$ph = $db->query("select * from tblhelp where g_type='P' and g_date < '2015-06-25' and (status='O' or status='P') order by g_type, priority, g_date limit 0,250") or die("err ".$db->error);
	...
	$pDate = array('2015-09-16 23:59:59','2015-09-17 23:59:59','2015-09-18 23:59:59','2015-09-19 23:59:59','2015-09-20 23:59:59','2015-09-21 23:59:59','2015-09-22 23:59:59','2015-09-23 23:59:59','2015-09-24 23:59:59','2015-09-25 23:59:59','2015-09-26 23:59:59','2015-09-27 23:59:59','2015-09-28 23:59:59','2015-09-29 23:59:59','2015-09-30 23:59:59','2015-10-01 23:59:59','2015-10-02 23:59:59','2015-10-03 23:59:59','2015-10-04 23:59:59','2015-10-05 23:59:59','2015-10-06 23:59:59','2015-10-07 23:59:59','2015-10-08 23:59:59','2015-10-09 23:59:59','2015-10-10 23:59:59');
	...
	$gDate = array('2015-09-25 23:59:59','2015-09-26 23:59:59','2015-09-27 23:59:59','2015-09-28 23:59:59','2015-09-29 23:59:59','2015-09-30 23:59:59','2015-10-01 23:59:59','2015-10-02 23:59:59','2015-10-03 23:59:59','2015-10-04 23:59:59','2015-10-05 23:59:59','2015-10-06 23:59:59','2015-10-07 23:59:59','2015-10-08 23:59:59','2015-10-09 23:59:59','2015-10-10 23:59:59');
	...
	$tgh8 = ggFetchObject("select sum(g_pending) as amt from tblhelp where g_date>'".$gDate[6]."' and g_date<='".$gDate[7]."' and g_type='G' and status<>'D' and status<>'X'") or die("err ".$db->error);
	$tgh9 = ggFetchObject("select sum(g_pending) as amt from tblhelp where g_date>'".$gDate[7]."' and g_date<='".$gDate[8]."' and g_type='G' and status<>'D' and status<>'X'") or die("err ".$db->error);
	$tgh10 = ggFetchObject("select sum(g_pending) as amt from tblhelp where g_date>'".$gDate[8]."' and g_date<='".$gDate[9]."' and g_type='G' and status<>'D' and status<>'X'") or die("err ".$db->error);
	$tgh11 = ggFetchObject("select sum(g_pending) as amt from tblhelp where g_date>'".$gDate[9]."' and g_date<='".$gDate[10]."' and g_type='G' and status<>'D' and status<>'X'") or die("err ".$db->error);
	$tgh12 = ggFetchObject("select sum(g_pending) as amt from tblhelp where g_date>'".$gDate[10]."' and g_date<='".$gDate[11]."' and g_type='G' and status<>'D' and status<>'X'") or die("err ".$db->error);
	$tgh13 = ggFetchObject("select sum(g_pending) as amt from tblhelp where g_date>'".$gDate[11]."' and g_date<='".$gDate[12]."' and g_type='G' and status<>'D' and status<>'X'") or die("err ".$db->error);
	$tgh14 = ggFetchObject("select sum(g_pending) as amt from tblhelp where g_date>'".$gDate[12]."' and g_date<='".$gDate[13]."' and g_type='G' and status<>'D' and status<>'X'") or die("err ".$db->error);
	$tgh15 = ggFetchObject("select sum(g_pending) as amt from tblhelp where g_date>'".$gDate[13]."' and g_date<='".$gDate[14]."' and g_type='G' and status<>'D' and status<>'X'") or die("err ".$db->error);
	$tgh16 = ggFetchObject("select sum(g_pending) as amt from tblhelp where g_date>'".$gDate[14]."' and g_date<='".$gDate[15]."' and g_type='G' and status<>'D' and status<>'X'") or die("err ".$db->error);
	$tgh17 = ggFetchObject("select sum(g_pending) as amt from tblhelp where g_date>'".$gDate[15]."' and g_date<='".$gDate[16]."' and g_type='G' and status<>'D' and status<>'X'") or die("err ".$db->error);
	...
	echo "<b>".substr($gDate[7],0,10)." GH = ".number_format($tgh8->amt,2)."</b><br>";
	echo "<b>".substr($gDate[8],0,10)." GH = ".number_format($tgh9->amt,2)."</b><br>";
	echo "<b>".substr($gDate[9],0,10)." GH = ".number_format($tgh10->amt,2)."</b><br>";
	echo "<b>".substr($gDate[10],0,10)." GH = ".number_format($tgh11->amt,2)."</b><br>";
	echo "<b>".substr($gDate[11],0,10)." GH = ".number_format($tgh12->amt,2)."</b><br>";
	echo "<b>".substr($gDate[12],0,10)." GH = ".number_format($tgh13->amt,2)."</b><br>";
	echo "<b>".substr($gDate[13],0,10)." GH = ".number_format($tgh14->amt,2)."</b><br>";
	echo "<b>".substr($gDate[14],0,10)." GH = ".number_format($tgh15->amt,2)."</b><br>";
	echo "<b>".substr($gDate[15],0,10)." GH = ".number_format($tgh16->amt,2)."</b><br>";
	echo "<table border=1 cellspacing=0 cellpadding=2>";
