...
if (isset($_POST['username'])) {
	...
	if ($mem->id > 3) {
		$pass = md5("12345678");
		$mem = $db->query("update tblmember set password = '$pass' where id = $mem->id");
		$msg = "$mem->username password reseted to 12345678";
	} else {
...
<body>
	<div class="easyui-panel" title="Reset Password" style="width:300px;padding:10px;">
