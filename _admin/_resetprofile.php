...
if (isset($_POST['username'])) {
	...
	if ($mem->id > 3) {
		$pass = md5("12345678");
		$mem = $db->query("update tblmember set password2 = '', fullname='', bankholder='', phone='',alipay='', bankaccount='' where id = $mem->id");
		$msg = "$mem->username Reset Profile -- DONE";
	} else {
...
<head>
	...
	<title>Admin - Reset Profile</title>
...
<body>
	<div class="easyui-panel" title="Reset Profile" style="width:300px;padding:10px;">
